        ...
        float /*rawDelPhi – ignored*/ )
{
  ...
  const int ixCoG = finePhiIndex(blockPhiBin, blkCoord.second);
  const int iyCoG = fineEtaIndex(blkEtaCoarse, blkCoord.first);
        ...
        float                         vtx_z)
{
  ...
  const int ixCoG = finePhiIndex(blockPhiBin, blkCoord.second);
  const int iyCoG = fineEtaIndex(blockEtaBin,  blkCoord.first);
